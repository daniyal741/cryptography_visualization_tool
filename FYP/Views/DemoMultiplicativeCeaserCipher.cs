...
namespace FYP
{
    public partial class DemoMultiplicativeCeaserCipher : UserControl
    {

        public DemoMultiplicativeCeaserCipher()
        {
            InitializeComponent();
        }

        private void DemoMultiplicativeCeaserCipher_Load(object sender, EventArgs e)
        {

        }
        char[] plain_text;
        int keyy, flag = 0, flag1 = 0, flag2 = 0, flag3 = 0, flag4 = 0, flag5 = 0, flag6 = 0, flag7 = 0, flag8 = 0, flag9 = 0, flag10 = 0;
        public int len = 0,seconds=0,i=0;
        public string plaintext { get; set; }
        public string ciphertext { get; set; }
        public int key { get; set; }
        DataTable dt = new DataTable();
        multiplicativeCeaserCipherView caesar;
        ...
        public DemoMultiplicativeCeaserCipher(multiplicativeCeaserCipherView obj)
        {
            InitializeComponent();
            this.caesar = obj;
            ...
            Control[] syncedCtrls = new Control[] { PlaintextBox, CiphertextBox, arrow1Box, PlainvalueBox, PlusBox, KeyBox, ModeRichTextBox, CiphervalueBox, arrow2Box, CiphertextBox };
        ...
        {
            multiplicativeCeaserCipherView uc_caesarCipher = new multiplicativeCeaserCipherView();
        ...
        private void btnNext_Click_1(object sender, EventArgs e)
        {
            ...
            {
                timer1.Stop();
                DemoMultiplicativeCaesarDecrypt uc_demoAdditiveCaesarCipherDecrypt = new DemoMultiplicativeCaesarDecrypt(this);
                ...
                MainForm.Instance.panelContain.Controls["DemoMultiplicativeCaesarDecrypt"].BringToFront();
            }
            catch (Exception)
            {
        ...
        {
            MessageBox.Show(" CipherText = PlianText * Key MOD 26", "Important Query", MessageBoxButtons.OK, MessageBoxIcon.Question);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            seconds++;
                ...
                {
                    ModeRichTextBox.Text += String.Concat("%    ", "26", "\n");
                    flag5 = 1;
                }
